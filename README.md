...
- API communication via **HTTP** (libcurl)
- JSON handling with **cJSON**, including utility functions
- Lightweight, modular, and easy to extend
- Clear separation between game logic (`game.c`) and interface (`main.c`)
- Static version, which is available in the Releases tab
