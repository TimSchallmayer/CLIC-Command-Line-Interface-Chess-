...
bool introduction() {
    ...
    while (true) {
        ...
        } else if (strcmp(color, "random") == 0 || color[0] =='r')
        {
            ...
            printf("2. You can move a piece by stating the position to where it schould go. For Example: Rook E5.\nYou can also use the fist Letter of each piece (R E5). The coordinates and pieces are not case sensitive.\n");
